...
(function (ErrorCode) {
    ...
    ErrorCode[ErrorCode["UNPROCESSABLE_ENTITY"] = 2004] = "UNPROCESSABLE_ENTITY";
    ErrorCode[ErrorCode["INTERNAL_EXCEPTION"] = 3001] = "INTERNAL_EXCEPTION";
    ErrorCode[ErrorCode["UNATHORIZED"] = 4001] = "UNATHORIZED";
    ErrorCode[ErrorCode["UNAUTHENTICATED"] = 4002] = "UNAUTHENTICATED";
