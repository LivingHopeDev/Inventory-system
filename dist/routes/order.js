...
orderRoute.post("/", [middlewares_1.authMiddleware], controllers_1.createOrderFromCartItems);
orderRoute.get("/", [middlewares_1.authMiddleware], controllers_1.getAllOrders);
orderRoute.get("/:id", [middlewares_1.authMiddleware], controllers_1.getOrderById);
orderRoute.patch("/:id/status", [middlewares_1.authMiddleware, middlewares_1.adminMiddleware], controllers_1.updateOrderStatus);
orderRoute.patch("/:id/cancel", [middlewares_1.authMiddleware], controllers_1.cancelOrder);
orderRoute.delete("/:id", [middlewares_1.authMiddleware, middlewares_1.adminMiddleware], controllers_1.deleteOrder);
/**
 * @swagger
 * /api/v1/orders:
 *   post:
