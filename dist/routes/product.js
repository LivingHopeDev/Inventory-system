...
productRoute.post("/", multer_1.uploadFiles, (0, middlewares_1.validateData)(schema_1.productSchema), [middlewares_1.authMiddleware, middlewares_1.adminMiddleware], controllers_1.createProduct);
productRoute.get("/", controllers_1.getAllProduct);
productRoute.get("/search", controllers_1.searchProduct);
productRoute.get("/:id", controllers_1.getProductById);
productRoute.patch("/:id", multer_1.uploadFiles, (0, middlewares_1.validateData)(schema_1.productSchema), [middlewares_1.authMiddleware, middlewares_1.adminMiddleware], controllers_1.updateProduct);
productRoute.delete("/:id", [middlewares_1.authMiddleware, middlewares_1.adminMiddleware], controllers_1.deleteProduct);
/**
 * @swagger
 * /products:
 *   post:
