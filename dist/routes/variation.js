...
exports.variationRoute = void 0;
const schema_1 = require("../schema");
const middlewares_1 = require("../middlewares");
const controllers_1 = require("../controllers");
const express_1 = require("express");
const variationRoute = (0, express_1.Router)();
exports.variationRoute = variationRoute;
variationRoute.get("/", controllers_1.getAllVariation);
variationRoute.post("/", (0, middlewares_1.validateData)(schema_1.variationSchema), [middlewares_1.authMiddleware, middlewares_1.adminMiddleware], controllers_1.createVariation);
variationRoute.patch("/:id", (0, middlewares_1.validateData)(schema_1.variationSchema), [middlewares_1.authMiddleware, middlewares_1.adminMiddleware], controllers_1.updateVariation);
variationRoute.delete("/:id", [middlewares_1.authMiddleware, middlewares_1.adminMiddleware], controllers_1.deleteVariation);
/**
 * @swagger
 * /variations:
 *   post:
